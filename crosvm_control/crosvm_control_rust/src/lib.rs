...
//! "Inner" rust implementation of control library. Since the outer crate
//! exports functions, enums, as a lib for C/C++ code they cannot be used for
//! rust code. The inner implementation allows for use from rust code, be it
//! internal or external to crosvm.

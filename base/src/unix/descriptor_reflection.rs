...
/// ```
/// use serde_json::to_string;
/// use crate::unix::{FileSerdeWrapper, SerializeDescriptors};
/// use tempfile::tempfile;
///
/// let tmp_f = tempfile().unwrap();
/// let data = FileSerdeWrapper(tmp_f);
...
/// use crate::unix::RawDescriptor;
///
/// #[derive(Serialize, Deserialize)]
/// struct RawContainer {
///     #[serde(with = "crate::unix::with_raw_descriptor")]
///     rd: RawDescriptor,
/// }
/// ```
...
///     #[serde(with = "crate::unix::with_as_descriptor")]
///     file: File,
/// }
/// ```

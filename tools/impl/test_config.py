...
CRATE_OPTIONS: dict[str, list[TestOption]] = {
    ...
    "hypervisor": [TestOption.DO_NOT_RUN_AARCH64, TestOption.DO_NOT_RUN_ARMHF],  # b/181672912
    ...
    "kvm": [TestOption.DO_NOT_RUN_AARCH64, TestOption.DO_NOT_RUN_ARMHF],  # b/181674144

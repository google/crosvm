...
//! This file defines virtio device IDs. IDs with large values (counting down from 63) are
//! nonstandard and not defined by the virtio specification.
...
pub const VIRTIO_ID_VIDEO_ENC: u32 = 30;
pub const VIRTIO_ID_VIDEO_DEC: u32 = 31;
